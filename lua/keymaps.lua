...
-- init.vim Commands -----------------------------------------------------------
keymap("n", "<Leader>fvg", "<Cmd>excute 'e' g:NVIM_INIT<CR>", opts)      -- Goto init.vim
keymap("n", "<Leader>fve", "<Cmd>execute 'vsplit' g:NVIM_INIT<CR>", opts) -- Edit init.vim
keymap("n", "<Leader>fvu", "<Cmd>execute 'source' g:NVIM_INIT<CR>", opts) -- Update init.vim
--------------------------------------------------------------------------------
...
-- Replace ---------------------------------------------------------------------
keymap("n", "<Leader>rw", "ciw<ESC>\"0p", opts)  -- Replace word under currsor with yanked text
--------------------------------------------------------------------------------
